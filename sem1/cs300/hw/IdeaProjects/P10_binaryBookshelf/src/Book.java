...
public class Book {
  ...
  public boolean equals(Object o) {
    if(o == null) {
      ...
      return this.compareTo((Book) o, Attribute.ID) == 0 && this.compareTo((Book) o, Attribute.AUTHOR) == 0 &&
          this.compareTo((Book) o, Attribute.PAGECOUNT) == 0 && this.compareTo((Book) o, Attribute.TITLE) == 0;
    } else {
      return false;
    }
  }
