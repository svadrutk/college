...
public class Driver {
  ...
  private static void getByKey() throws NotDirectoryException {
    System.out.print("Please designate a folder: ");
    cin.nextLine();
    File folder = new File(cin.nextLine());
  ...
  private static void getBySize() {
    ...
    try {
      ...
      System.out.println();
    } catch (InputMismatchException | NotDirectoryException e) {
      System.out.println(e.getMessage());
    }
  }

  private static void handleCommand(int command) throws NotDirectoryException {
    switch (command) {
      case 1:
