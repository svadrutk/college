function setup() {
    ...
    var CameraCurve = function(angle) {
        var distance = 120.0;
        var eye = vec3.create();
        eye[0] = distance*Math.cos(5 * viewAngle) * Math.sin(3 * viewAngle);
        eye[1] = distance * Math.sin(3 * viewAngle) * Math.sin(5 * viewAngle);
        eye[2] = distance * Math.cos(3 * viewAngle);  
    ...
    mat4.rotateZ(tVP_PROJ_VIEW_Camera,tVP_PROJ_VIEW_Camera,slider3.value);
    linkage("green",tVP_PROJ_VIEW_Camera);
    var Tred_to_green = mat4.create();
    mat4.fromTranslation(Tred_to_green,[100,0,0]);
    mat4.rotateZ(Tred_to_green,Tred_to_green,slider4.value);
    mat3.scale(Tred_to_green,Tred_to_green,[0.5,1]);
    var Tred_to_canvas = mat4.create(); 
    mat4.multiply(Tred_to_canvas,tVP_PROJ_VIEW_Camera,Tred_to_green);
   ...
   // drawTrajectory(0.0,1.0,100,C0,tVP_PROJ_VIEW_Observer,"red");
    ...
    mat4.rotateZ(tVP_PROJ_VIEW_Observer,tVP_PROJ_VIEW_Observer,slider3.value);
    linkage("green",tVP_PROJ_VIEW_Observer);
    var Tred_to_green = mat4.create();
    mat4.fromTranslation(Tred_to_green,[100,0,0]);
    mat4.rotateZ(Tred_to_green,Tred_to_green,slider4.value);
    mat3.scale(Tred_to_green,Tred_to_green,[0.5,1]);
    var Tred_to_canvas = mat4.create(); 
    mat4.multiply(Tred_to_canvas,tVP_PROJ_VIEW_Observer,Tred_to_green);
    linkage("red", Tred_to_canvas);
