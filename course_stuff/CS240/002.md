...
---
**PROOF BY CASES**: The process of breaking a complicated problem into easier sub-problems. However, some philosophers (intuitionists) worry that this method is
